/**
 * VISITANTE
 * Define las características de un visitante del parque acuatico. Es sumamente necesario el uso del reloj global, el parque que visita y el colectivo si lo usa.
...
public class Visitante implements Runnable {
     ...
     * @param vaColectivo define si el visitante realiza el viaje en colectivo o por su cuenta (auto)
     */
    public Visitante(String nombreVisitante, Reloj reloj, ParqueAcuatico parqueAcuatico, Colectivo colectivo, boolean vaColectivo) {
    ...
    /**
     * En su ejecución el visitante verifica si el parque está abierto para poder visitarlo. Luego, de viajar en colectivo debe subirse al mismo y luego bajarse.
     * Si va al parque por su cuenta, se simula arbitrariamente el viaje en 2 segundos.
     * Una vez que el visitante arriba al parque, debe pasar por los molinetes y seleccionar aleatoriamente qué es lo que hará dentro.
     */
    @Override
    public void run() {
        while (true) {
